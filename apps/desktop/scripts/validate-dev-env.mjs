...
const remoteBridgeBaseUrl =
  configured("HITECHCLOUD_PROACTIVE_URL") ||
  configured("HITECHCLOUD_CLI_PROACTIVE_URL") ||
  configured("HITECHCLOUD_BACKEND_BASE_URL") ||
  configured("HITECHCLOUD_DESKTOP_CONTROL_PLANE_BASE_URL");
...
if (!remoteBridgeBaseUrl) {
  ...
  console.error(
    `[validate-dev-env] Set HITECHCLOUD_BACKEND_BASE_URL or HITECHCLOUD_PROACTIVE_URL in ${envFileLabel} before running desktop:dev.`
  );
  console.error(
