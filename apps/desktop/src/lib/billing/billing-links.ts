...
export const HITECHCLOUD_HOME_URL = "https://www.hitechcloud.vn";
...
export function buildDesktopBillingLinks(appBaseUrl: string): DesktopBillingLinks {
  const normalizedBaseUrl = normalizeBaseUrl(appBaseUrl) || HITECHCLOUD_HOME_URL;
  return {
