...
- `hitechcloud_model_proxy` for hitechcloudOS Proxy
...
Those transport decisions are now internal to hitechcloudOS Proxy rather than separate desktop-configurable providers.
