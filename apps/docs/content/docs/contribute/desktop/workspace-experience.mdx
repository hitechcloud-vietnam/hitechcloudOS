...
description: The design contract for the workspace surface in hitechcloudOS Desktop.
---

This page defines the design contract for the workspace surface in hitechcloudOS Desktop.
...
The workspace is the operator's entrypoint into the `hitechcloudOS` environment. The UI should not behave like a generic folder browser. It should expose the operating context the agent is actually working inside.
