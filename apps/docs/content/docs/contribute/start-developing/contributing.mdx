...
| SDK packages | `sdk/app-sdk/**`, `sdk/app-builder-sdk/**`, `sdk/ui/**` | Run the matching `build`, `typecheck`, and `test` scripts for the package you changed, for example `bun --filter=@hitechcloud/app-builder-sdk run typecheck` and `bun --filter=@hitechcloud/app-builder-sdk run test` |
