...
**Goal:** Add read-only hosted billing visibility to `hitechcloudOS/desktop`, including a top-bar credits badge, an account-level plan and credits summary, low-balance warnings in chat, and web-only billing actions.
...
- Test: `hitechcloudOS/desktop/electron/settings-pane-routing.test.mjs`
- Create: `hitechcloudOS/desktop/electron/billing-ipc.test.mjs`

**Step 1: Write the failing test**

Add a new test file `hitechcloudOS/desktop/electron/billing-ipc.test.mjs` that checks the source of `main.ts` for:
...
In `hitechcloudOS/desktop/electron/main.ts`:
...
In `hitechcloudOS/desktop/electron/preload.ts`:
...
In `hitechcloudOS/desktop/src/types/electron.d.ts`:
...
```bash
git -C hitechcloudOS add desktop/electron/main.ts desktop/electron/preload.ts desktop/src/types/electron.d.ts desktop/electron/billing-ipc.test.mjs
git -C hitechcloudOS commit -m "feat: add desktop billing ipc bridge"
```

### Task 2: Add A Shared Renderer Billing Hook

**Files:**
- Create: `hitechcloudOS/desktop/src/lib/billing/useDesktopBilling.ts`
- Test: `hitechcloudOS/desktop/src/lib/billing/useDesktopBilling.test.mjs`

**Step 1: Write the failing test**

Create `hitechcloudOS/desktop/src/lib/billing/useDesktopBilling.test.mjs` to assert the hook source:
...
```bash
git -C hitechcloudOS add desktop/src/lib/billing/useDesktopBilling.ts desktop/src/lib/billing/useDesktopBilling.test.mjs
git -C hitechcloudOS commit -m "feat: add desktop billing renderer hook"
```

### Task 3: Add The Top-Bar Credits Pill

**Files:**
- Create: `hitechcloudOS/desktop/src/components/billing/CreditsPill.tsx`
...
- Test: `hitechcloudOS/desktop/src/components/layout/TopTabsBar.test.mjs`

**Step 1: Write the failing test**

Create `hitechcloudOS/desktop/src/components/layout/TopTabsBar.test.mjs` to assert:
...
```bash
git -C hitechcloudOS add desktop/src/components/billing/CreditsPill.tsx desktop/src/components/layout/TopTabsBar.tsx desktop/src/components/layout/AppShell.tsx desktop/src/components/layout/TopTabsBar.test.mjs
git -C hitechcloudOS commit -m "feat: add desktop credits pill to top bar"
```

### Task 4: Add A Read-Only Account Billing Summary Card

**Files:**
- Create: `hitechcloudOS/desktop/src/components/billing/BillingSummaryCard.tsx`
- Modify: `hitechcloudOS/desktop/src/components/auth/AuthPanel.tsx`
- Modify: `hitechcloudOS/desktop/src/components/layout/SettingsDialog.tsx`
- Test: `hitechcloudOS/desktop/src/components/layout/SettingsDialog.test.mjs`

**Step 1: Write the failing test**

Extend `hitechcloudOS/desktop/src/components/layout/SettingsDialog.test.mjs` so it asserts:
...
```bash
git -C hitechcloudOS add desktop/src/components/billing/BillingSummaryCard.tsx desktop/src/components/auth/AuthPanel.tsx desktop/src/components/layout/SettingsDialog.tsx desktop/src/components/layout/SettingsDialog.test.mjs
git -C hitechcloudOS commit -m "feat: add read-only desktop billing summary"
```

### Task 5: Add Low-Balance Warning And Out-Of-Credits Guard In Chat

**Files:**
- Modify: `hitechcloudOS/desktop/src/components/panes/ChatPane.tsx`
- Test: `hitechcloudOS/desktop/src/components/panes/ChatPane.test.mjs`

**Step 1: Write the failing test**

Extend `hitechcloudOS/desktop/src/components/panes/ChatPane.test.mjs` so it asserts source contains:
...
```bash
git -C hitechcloudOS add desktop/src/components/panes/ChatPane.tsx desktop/src/components/panes/ChatPane.test.mjs
git -C hitechcloudOS commit -m "feat: add desktop low-credit chat guardrails"
```

### Task 6: End-To-End Verification

**Files:**
- Modify: `hitechcloudOS/docs/plans/2026-04-02-desktop-billing-credits-implementation-plan.md`
...
```bash
git -C hitechcloudOS add desktop/src/components/billing desktop/src/components/layout desktop/src/components/auth desktop/src/components/panes desktop/src/lib/billing desktop/electron desktop/src/types/electron.d.ts docs/plans/2026-04-02-desktop-billing-credits-implementation-plan.md
git -C hitechcloudOS commit -m "feat: add read-only desktop billing visibility"
```
