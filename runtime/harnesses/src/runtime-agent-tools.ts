export const RUNTIME_AGENT_TOOL_DEFINITIONS = [
  ...
  {
    id: "hitechhub_upload_image",
    description:
      "Upload a LOCAL image file to Hitechhub and get back an { image_id }. Use this to attach an image (e.g. one the user gave you — pass its workspace_path) to a Hitechhub post: upload it here first, then pass the returned id in the Hitechhub create_post tool's imageIds. Accepts png/jpeg/webp/gif up to 4 MB.",
    policy: "mutate"
  },
  {
